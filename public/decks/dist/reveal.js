...
!(function (e, t) {
  ...
  ;(Z.exports = function (e, t, n, i) {
    ...
    'function' == typeof n &&
      ...
      e !== Ue
        ? (a ? !s && e[t] && (o = !0) : delete e[t], o ? (e[t] = n) : Be(e, t, n))
        : o
        ? (e[t] = n)
        : qe(t, n)
  ...
  ;(_r && qr) ||
    ...
    Ur
      ...
      : Vr && !Hr
      ? ((Rr = (Ar = new Vr()).port2), (Ar.port1.onmessage = Qr), (kr = Dr(Rr.postMessage, Rr, 1)))
      : Or.addEventListener &&
  ...
  var is,
    ...
    Es = !1
  ;[].keys &&
    ('next' in (as = [].keys()) ? (rs = ys(ys(as))) !== Object.prototype && (is = rs) : (Es = !0)),
    (null == is ||
      ms(function () {
        var e = {}
  ...
  var Hs =
      ...
      function (e, t) {
        ...
        return (
          null !== e
            ? ((Ds.prototype = Cs(e)), (n = new Ds()), (Ds.prototype = null), (n[js] = e))
            : (n = zs()),
          void 0 === t ? n : Ns(n, t)
        )
      },
    ...
    cl = function (e, t, n, i, r, a, o) {
      ...
      if (
        (g &&
          ...
          el !== Object.prototype &&
            s.next &&
            ($s(s) !== el && (Xs ? Xs(s, el) : 'function' != typeof s[nl] && Js(s, nl, ol)),
            Gs(s, d, !0))),
        r == rl &&
          v &&
          v.name !== rl &&
        ...
        [
          ...
          function (e, r) {
            ...
            for (var f = 0, v = 0, p = []; v < s.length; ) {
              ...
              if (null === m || (g = fd(ld(d.lastIndex + (dd ? v : 0)), s.length)) === f)
                v = sd(s, v, c)
              else {
    ...
    return [
      ...
      function (e, i) {
        ...
        for (var p, g = '', m = 0, y = 0; y < f.length; y++) {
          v = f[y]
          for (
            var b = String(v[0]), w = ph(gh(uh(v.index), c.length), 0), S = [], E = 1;
            E < v.length;
            E++
          )
      ...
      if (e) {
        var t = function (e) {
          ...
          f = function (e) {
            return (
              e.dirty !== r ||
              (e.dirty === r && e.element.parentNode.clientWidth !== e.availableWidth)
            )
          },
          v = function (t) {
        ...
        Ri(e, [
          ...
          },
          {
            ...
            value: function (e) {
              ...
              ;(e.style.display = this.Reveal.getConfig().display),
                kh(e, 'img[data-src], video[data-src], audio[data-src], iframe[data-src]').forEach(
                  function (e) {
                ...
                kh(e, 'video, audio').forEach(function (e) {
                  ...
                  kh(e, 'source[data-src]').forEach(function (e) {
                    ...
                    jh && 'VIDEO' === e.tagName && e.setAttribute('playsinline', ''),
                    t > 0 && e.load()
                })
          ...
          },
          {
            ...
            value: function (e) {
              ...
              t &&
                ...
                kh(e, 'video[data-lazy-loaded] source[src], audio source[src]').forEach(function (
                  e
                ) {
                  e.setAttribute('data-src', e.getAttribute('src')), e.removeAttribute('src')
                })
          ...
          },
          {
            ...
            value: function () {
              var e = this,
                t = function (t, n, i) {
                  kh(e.Reveal.getSlidesElement(), 'iframe[' + t + '*="' + n + '"]').forEach(
                    function (e) {
              ...
              e &&
                ...
                kh(e, 'video, audio').forEach(function (e) {
                  if (!Ph(e, '.fragment') || Ph(e, '.fragment.visible')) {
                    ...
                    if (
                      ('boolean' != typeof n &&
                        (n = e.hasAttribute('data-autoplay') || !!Ph(e, '.slide-background')),
            ...
            value: function (e) {
              ...
              if (t && t.contentWindow) {
                ...
                if (n && i) {
                  ...
                  'boolean' != typeof r &&
                    (r = t.hasAttribute('data-autoplay') || !!Ph(t, '.slide-background')),
  ...
  Xh(
    { target: 'Array', proto: !0, forced: !rf },
    {
      slice: function (e, t) {
        ...
        if (
          Jh(a) &&
          ('function' != typeof (n = a.constructor) || (n !== Array && !Jh(n.prototype))
          ...
          },
          {
            ...
            value: function () {
              kh(
                ...
                kh(this.Reveal.getRevealElement(), '[data-auto-animate-target]').forEach(function (
                  e
                ) {
            ...
            value: function (e, t, n, i, r) {
              ...
              t.classList.contains('fragment') &&
                ...
                e.classList.contains('fragment') &&
                  (e.className.match(th) || [''])[0] === (t.className.match(th) || [''])[0] &&
            ...
            value: function () {
              ...
              this.Reveal.getHorizontalSlides().forEach(function (t, n) {
                t.setAttribute('data-index-h', n),
                  xh(t, 'translate3d(' + n * e.overviewSlideWidth + 'px, 0, 0)'),
                  t.classList.contains('stack') &&
                    kh(t, 'section').forEach(function (t, i) {
                      t.setAttribute('data-index-h', n),
                        t.setAttribute('data-index-v', i),
                        xh(t, 'translate3d(0, ' + i * e.overviewSlideHeight + 'px, 0)')
                    })
              }),
            ...
            value: function () {
              ...
              if (this.Reveal.getConfig().overview) {
                ;(this.active = !1),
                  ...
                  kh(this.Reveal.getBackgroundsElement(), '.slide-background').forEach(function (
                    e
                  ) {
                    xh(e, '')
                  }),
        ...
        Ri(e, [
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if ('function' == typeof t.keyboardCondition && !1 === t.keyboardCondition(e))
                return !0
          ...
          },
          {
            ...
            value: function () {
              ...
              if (!/^[0-9]*$/.test(r[0]) && a.length) {
                ...
                e.fragmentInURL && ((u = parseInt(r[2], 10)), isNaN(u) && (u = void 0)),
                  (h === t.h && f === t.v && void 0 === u) || this.Reveal.slide(h, f, u)
              }
            },
          },
          {
      ...
      function R(e, n) {
        ...
        if (i === t) {
          if (((n.delegate = null), 'throw' === n.method)) {
            if (
              e.iterator.return &&
              ((n.method = 'return'), (n.arg = t), R(e, n), 'throw' === n.method)
            )
              return p
            ;(n.method = 'throw'),
                  ...
                  function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        ...
                        case 8:
                          return (
                            Nh('@page{size:' + a + 'px ' + o + 'px; margin: 0px;}'),
                            Nh(
                          ...
                          return (
                            ...
                            n.forEach(function (e, n) {
                              if (!1 === e.classList.contains('stack')) {
                                ...
                                ;((1 === (f = Math.min(f, t.pdfMaxPagesPerSlide)) && t.center) ||
                                ...
                                if (
                                  ...
                                  (v.style.height = (o + t.pdfPageHeightOffset) * f + 'px'),
                                  v.appendChild(e),
                                  (e.style.left = r + 'px'),
                                  (e.style.top = d + 'px'),
                                  (e.style.width = s + 'px'),
                                ...
                                if (t.pdfSeparateFragments) {
                                  ...
                                  kh(v, '.fragment:not(.fade-out)').forEach(function (e) {
      ...
      return (
        Ri(e, [
          ...
          },
          {
            ...
            value: function () {
              return (
                this.Reveal.getSlidesElement().querySelectorAll('[data-notes], aside.notes')
                  .length > 0
              )
            },
          },
  ...
  function _f(e, t) {
    ...
    function H() {
      l.showHiddenSlides ||
        kh(v.wrapper, 'section[data-visibility="hidden"]').forEach(function (e) {
          e.parentNode.removeChild(e)
        })
    }
    function U() {
      v.slides.classList.add('no-transition'),
        jh ? v.wrapper.classList.add('no-hover') : v.wrapper.classList.remove('no-hover'),
        k.render(),
        S.render(),
        P.render(),
        C.render(),
          ...
          function (e) {
            ...
            if (
              ...
              if (!1 === eh.test(t.method)) {
                ...
                console.warn(
                  'reveal.js: "' + t.method + '" is is blacklisted from the postMessage API'
                )
          },
          !1
        )
    ...
    function J(e) {
      'string' == typeof e.layout && (f.layout = e.layout),
        ...
        f.layout ? xh(v.slides, f.layout + ' ' + f.overview) : xh(v.slides, f.overview)
    }
    function Q(e) {
      var t = e.target,
    ...
    function oe() {
      if (v.wrapper && !I.isPrintingPDF()) {
        if (!l.disableLayout) {
          ...
          for (
            var n = Array.from(v.wrapper.querySelectorAll(Jd)), i = 0, r = n.length;
            i < r;
            i++
          ) {
            var a = n[i]
    ...
    function Ke() {
      g && !b && ((b = !0), Q({ type: 'autoslidepaused' }), clearTimeout(m), o && o.setPlaying(!1))
    }
    function Ye() {
