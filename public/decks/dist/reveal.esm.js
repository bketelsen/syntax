...
const e = /registerPlugin|registerKeyboardShortcut|addKeyBinding|addEventListener/,
  ...
  p =
    /(iphone|ipod|ipad|android)/gi.test(g) ||
    ...
    if (e) {
      var t = function (e) {
        ...
        g = function (e) {
          return (
            e.dirty !== n ||
            (e.dirty === n && e.element.parentNode.clientWidth !== e.availableWidth)
          )
        },
        v = function (t) {
        ...
        S = function (e) {
          e.observeMutations &&
            ((e.observer = new MutationObserver(b(e, a))),
      ...
      var i = w({}, E, t),
        a = e.map(function (e) {
          ...
          return (
            ...
            { element: e, fit: b(t, s), unfreeze: R(t), freeze: A(t), unsubscribe: y(t) }
          )
        })
      return l(), a
    }
...
class A {
  ...
  load(e, t = {}) {
    ;(e.style.display = this.Reveal.getConfig().display),
      a(e, 'img[data-src], video[data-src], audio[data-src], iframe[data-src]').forEach((e) => {
      ...
      a(e, 'video, audio').forEach((e) => {
        ...
        a(e, 'source[data-src]').forEach((e) => {
          ...
          p && 'VIDEO' === e.tagName && e.setAttribute('playsinline', ''),
          t > 0 && e.load()
      })
      ...
      if (!1 === i.hasAttribute('data-loaded')) {
        ...
        if (s)
          ...
          r && e.setAttribute('loop', ''),
            l && (e.muted = !0),
            p && ((e.muted = !0), e.setAttribute('playsinline', '')),
            o.split(',').forEach((t) => {
  ...
  startEmbeddedContent(e) {
    e &&
      ...
      a(e, 'video, audio').forEach((e) => {
        ...
        if (
          ('boolean' != typeof t &&
            (t = e.hasAttribute('data-autoplay') || !!l(e, '.slide-background')),
      ...
      a(e, 'iframe[src]').forEach((e) => {
        ;(l(e, '.fragment') && !l(e, '.fragment.visible')) ||
  ...
  startEmbeddedIframe(e) {
    ...
    if (t && t.contentWindow) {
      ...
      if (i && a) {
        ...
        'boolean' != typeof e &&
          (e = t.hasAttribute('data-autoplay') || !!l(t, '.slide-background')),
...
const E = (e) => {
  ...
  return n
    ? { r: parseInt(n[1], 10), g: parseInt(n[2], 10), b: parseInt(n[3], 10), a: parseFloat(n[4]) }
    : null
}
class k {
  constructor(e) {
  ...
  sync(e) {
    ...
    e.classList.remove('has-dark-background'),
      ...
      a.background &&
        ...
        /\.(svg|png|jpg|jpeg|gif|bmp)([?#\s]|$)/gi.test(a.background)
    ...
    if (
      (Array.from(this.element.childNodes).forEach((t, r) => {
        t.classList.remove('past', 'present', 'future'),
          ...
          (e || r === i.h) &&
            a(t, '.slide-background').forEach((e, t) => {
...
class x {
  ...
  run(e, t) {
    ...
    if (
      ...
      let s = this.getAutoAnimatableElements(e, t).map((e) =>
        this.autoAnimateElements(e.from, e.to, e.options || {}, i, L++)
      )
      if (
  ...
  reset() {
    a(this.Reveal.getRevealElement(), '[data-auto-animate]:not([data-auto-animate=""])').forEach(
      (e) => {
  ...
  autoAnimateElements(e, i, a, n, s) {
    ...
    void 0 !== a.delay && (o.delay = a.delay),
      void 0 !== a.duration && (o.duration = a.duration),
      void 0 !== a.easing && (o.easing = a.easing)
    let r = this.getAutoAnimatableProperties('from', e, a),
      l = this.getAutoAnimatableProperties('to', i, a)
    if (
      i.classList.contains('fragment') &&
      (delete l.styles.opacity, e.classList.contains('fragment'))
    ) {
      ;(e.className.match(t) || [''])[0] === (i.className.match(t) || [''])[0] &&
        'forward' === n.slideDirection &&
        i.classList.add('visible', 'disabled')
    }
    ...
    for (let e in l.styles) {
      ...
      t === i
        ? delete l.styles[e]
        : (!0 === t.explicitValue && (l.styles[e] = t.value),
    ...
    if (c.length > 0) {
      ;(r.styles.transition = 'none'),
        (l.styles.transition = `all ${o.duration}s ${o.easing} ${o.delay}s`),
        (l.styles['transition-property'] = c.join(', ')),
        (l.styles['will-change'] = c.join(', ')),
        (d =
          ...
          s +
          '"] {' +
          Object.keys(l.styles)
            .map((e) => e + ': ' + l.styles[e] + ' !important;')
            .join('') +
          '}')
    }
    return d
  ...
  getAutoAnimateOptions(e, t) {
    ...
    return (
      e.dataset.autoAnimateEasing && (a.easing = e.dataset.autoAnimateEasing),
      e.dataset.autoAnimateDuration && (a.duration = parseFloat(e.dataset.autoAnimateDuration)),
      e.dataset.autoAnimateDelay && (a.delay = parseFloat(e.dataset.autoAnimateDelay)),
      a
    )
  }
  ...
  activate() {
    if (this.Reveal.getConfig().overview && !this.isActive()) {
      ;(this.active = !0),
        ...
        a(this.Reveal.getRevealElement(), '.slides section').forEach((e) => {
  ...
  layout() {
    this.Reveal.getHorizontalSlides().forEach((e, t) => {
      e.setAttribute('data-index-h', t),
        o(e, 'translate3d(' + t * this.overviewSlideWidth + 'px, 0, 0)'),
        e.classList.contains('stack') &&
          a(e, 'section').forEach((e, i) => {
            e.setAttribute('data-index-h', t),
              e.setAttribute('data-index-v', i),
              o(e, 'translate3d(0, ' + i * this.overviewSlideHeight + 'px, 0)')
          })
    }),
      Array.from(this.Reveal.getBackgroundsElement().childNodes).forEach((e, t) => {
        o(e, 'translate3d(' + t * this.overviewSlideWidth + 'px, 0, 0)'),
          a(e, '.slide-background').forEach((e, t) => {
...
class M {
  ...
  readURL() {
    ...
    if (!/^[0-9]*$/.test(n[0]) && s.length) {
      ...
      e.fragmentInURL && ((i = parseInt(n[2], 10)), isNaN(i) && (i = void 0)),
        (s === t.h && o === t.v && void 0 === i) || this.Reveal.slide(s, o, i)
    }
  }
  writeURL(e) {
    let t = this.Reveal.getConfig(),
...
class D {
  ...
  render() {
    ...
    ;(this.element = document.createElement('aside')),
      ...
      this.Reveal.getRevealElement().appendChild(this.element),
      (this.controlsLeft = a(t, '.navigate-left')),
      (this.controlsRight = a(t, '.navigate-right')),
      (this.controlsUp = a(t, '.navigate-up')),
      (this.controlsDown = a(t, '.navigate-down')),
      (this.controlsPrev = a(t, '.navigate-prev')),
      (this.controlsNext = a(t, '.navigate-next')),
...
class B {
  ...
  async setupPDF() {
    ...
    await new Promise(requestAnimationFrame),
      c('@page{size:' + s + 'px ' + o + 'px; margin: 0px;}'),
      c(
      ...
      await new Promise(requestAnimationFrame),
      this.Reveal.layoutSlideContents(r, l),
      t.forEach((e) => this.Reveal.slideContent.layout(e)),
      await new Promise(requestAnimationFrame)
    ...
    t.forEach(function (t, n) {
      if (!1 === t.classList.contains('stack')) {
        ...
        ;(v = Math.min(v, e.pdfMaxPagesPerSlide)),
          ((1 === v && e.center) || t.classList.contains('center')) &&
            (u = Math.max((o - g) / 2, 0))
        const p = document.createElement('div')
        if (
          (h.push(p),
          (p.className = 'pdf-page'),
          (p.style.height = (o + e.pdfPageHeightOffset) * v + 'px'),
          p.appendChild(t),
          (t.style.left = c + 'px'),
          (t.style.top = u + 'px'),
          (t.style.width = r + 'px'),
          t.slideBackgroundElement && p.insertBefore(t.slideBackgroundElement, t),
          e.showNotes)
        ) {
        ...
        if (e.pdfSeparateFragments) {
          ...
          a(p, '.fragment:not(.fade-out)').forEach(function (e) {
            e.classList.add('visible')
          })
      }
    }, this),
      await new Promise(requestAnimationFrame),
      h.forEach((e) => u.appendChild(e)),
...
function V(t, r) {
  ...
  let g,
    ...
    w = {},
    R = !1,
    E = { hasNavigatedHorizontally: !1, hasNavigatedVertically: !1 },
    L = [],
    z = 1,
    V = { layout: '', overview: '' },
    $ = {},
  ...
  function ue(e) {
    return (
      ($.wrapper = t),
      ($.slides = t.querySelector('.slides')),
      (w = { ...W, ...w, ...r, ...e, ...h() }),
      ge(),
      window.addEventListener('load', He, !1),
      re.load(w.plugins, w.dependencies).then(ve),
      new Promise((e) => c.on('ready', e))
    )
  }
  function ge() {
    !0 === w.embedded
      ? ($.viewport = l(t, '.reveal-viewport') || t)
      : (($.viewport = document.body), document.documentElement.classList.add('reveal-full-page')),
    ...
    ;(R = !0),
      ...
      setTimeout(() => {
        $.slides.classList.remove('no-transition'),
          ...
          Ce({ type: 'ready', data: { indexh: g, indexv: v, currentSlide: f } })
      }, 1),
      le.isPrintingPDF() &&
        (Ee(),
  ...
  function pe() {
    w.showHiddenSlides ||
      a($.wrapper, 'section[data-visibility="hidden"]').forEach((e) => {
        e.parentNode.removeChild(e)
      })
  }
  function me() {
    $.slides.classList.add('no-transition'),
      p ? $.wrapper.classList.add('no-hover') : $.wrapper.classList.remove('no-hover'),
      G.render(),
      Q.render(),
      ne.render(),
      se.render(),
      ...
      ($.pauseOverlay = d(
        ...
        'div',
        'pause-overlay',
        w.controls ? '<button class="resume-button">Resume presentation</button>' : null
      )),
      ($.statusElement = fe()),
      ...
      window.addEventListener(
        ...
        (t) => {
          ...
          if (
            ...
            '{' === i.charAt(0) &&
            '}' === i.charAt(i.length - 1) &&
            ((i = JSON.parse(i)), i.method && 'function' == typeof c[i.method])
          )
            if (!1 === e.test(i.method)) {
              const e = c[i.method].apply(c, i.args)
              Pe('callback', { method: i.method, result: e })
            } else
              console.warn(
                'reveal.js: "' + i.method + '" is is blacklisted from the postMessage API'
              )
        },
        !1
      )
  ...
  function Ae(e) {
    ...
    $.wrapper.classList.remove(t.transition),
      $.wrapper.classList.add(w.transition),
      $.wrapper.setAttribute('data-transition-speed', w.transitionSpeed),
      $.wrapper.setAttribute('data-background-transition', w.backgroundTransition),
      $.viewport.style.setProperty('--slide-width', w.width + 'px'),
      $.viewport.style.setProperty('--slide-height', w.height + 'px'),
      w.shuffle && tt(),
      n($.wrapper, 'embedded', w.embedded),
      n($.wrapper, 'rtl', w.rtl),
      n($.wrapper, 'center', w.center),
      !1 === w.pause && je(),
      w.previewLinks
      ...
      a > 1 &&
        ...
        ((y = new O($.wrapper, () => Math.min(Math.max((Date.now() - Y) / j, 0), 1))),
        y.on('click', zt),
        (_ = !1)),
      'default' !== w.navigationMode
        ? $.wrapper.setAttribute('data-navigation-mode', w.navigationMode)
  ...
  function Se() {
    window.addEventListener('resize', Dt, !1),
      w.touch && ce.bind(),
      w.keyboard && ie.bind(),
      w.progress && se.bind(),
      w.respondToHashChanges && ae.bind(),
      ne.bind(),
      de.bind(),
      $.slides.addEventListener('transitionend', Mt, !1),
      $.pauseOverlay.addEventListener('click', je, !1),
      w.focusBodyOnPageVisibilityChange && document.addEventListener('visibilitychange', It, !1)
  }
  function Ee() {
    ce.unbind(),
      de.unbind(),
      ...
      se.unbind(),
      ae.unbind(),
      window.removeEventListener('resize', Dt, !1),
      $.slides.removeEventListener('transitionend', Mt, !1),
      $.pauseOverlay.removeEventListener('click', je, !1)
  }
  function ke(e, i, a) {
  ...
  function xe(e) {
    'string' == typeof e.layout && (V.layout = e.layout),
      ...
      V.layout ? o($.slides, V.layout + ' ' + V.overview) : o($.slides, V.overview)
  }
  function Ce({ target: e = $.wrapper, type: t, data: a, bubbles: n = !0 }) {
  ...
  function Pe(e, t) {
    if (w.postMessageEvents && window.parent !== window.self) {
      let a = { namespace: 'reveal', eventName: e, state: bt() }
    ...
    if ($.wrapper && !le.isPrintingPDF()) {
      if (!w.disableLayout) {
        ...
        Be(w.width, w.height),
          ...
          (z = Math.min(e.presentationWidth / e.width, e.presentationHeight / e.height)),
          (z = Math.max(z, w.minScale)),
          (z = Math.min(z, w.maxScale)),
          1 === z
            ? (($.slides.style.zoom = ''),
              ($.slides.style.left = ''),
              ($.slides.style.top = ''),
              ...
              ($.slides.style.right = ''),
              xe({ layout: '' }))
            : z > 1 && b && window.devicePixelRatio < 2
            ? (($.slides.style.zoom = z),
              ($.slides.style.left = ''),
              ($.slides.style.top = ''),
              ($.slides.style.bottom = ''),
            ...
            : (($.slides.style.zoom = ''),
              ...
              xe({ layout: 'translate(-50%, -50%) scale(' + z + ')' }))
        ...
        t !== z && Ce({ type: 'resize', data: { oldScale: t, scale: z, size: e } })
      }
  ...
  function Ke() {
    if (w.pause) {
      ...
      Rt(), $.wrapper.classList.add('paused'), !1 === e && Ce({ type: 'paused' })
    }
  }
  function je() {
    const e = $.wrapper.classList.contains('paused')
    $.wrapper.classList.remove('paused'), wt(), e && Ce({ type: 'resumed' })
  }
  function Xe(e) {
  ...
  function Qe(e, t, i, a) {
    ...
    void 0 !== t || te.isActive() || (t = Ue(n[e])),
      m && m.parentNode && m.parentNode.classList.contains('stack') && Fe(m.parentNode, v)
    const s = L.concat()
    L.length = 0
    let o = g || 0,
      r = v || 0
    ;(g = it('.slides>section', void 0 === e ? g : e)),
      (v = it('.slides>section.present>section', void 0 === t ? v : t))
    let l = g !== o || v !== r
    l || (m = null)
    let d = n[g],
    ...
    l &&
      ...
      (m.hasAttribute('data-auto-animate') &&
        ...
        m.getAttribute('data-auto-animate-id') === f.getAttribute('data-auto-animate-id') &&
        !(g > o || v > r ? f : m).hasAttribute('data-auto-animate-restart') &&
        ((h = !0), $.slides.classList.add('disable-slide-transitions')),
      (K = 'running')),
      at(),
      He(),
    ...
    e: for (let e = 0, t = L.length; e < t; e++) {
      ...
      $.viewport.classList.add(L[e]), Ce({ type: L[e] })
    }
    for (; s.length; ) $.viewport.classList.remove(s.pop())
    l &&
      Ce({
        type: 'slidechanged',
        data: { indexh: g, indexv: v, previousSlide: m, currentSlide: f, origin: a },
      }),
      (!l && m) || (J.stopEmbeddedContent(m), J.startEmbeddedContent(f)),
      requestAnimationFrame(() => {
        be(ye(f))
      }),
      se.update(),
  ...
  function Ze() {
    Ee(),
      ...
      !1 === w.autoPlayMedia
        ? J.stopEmbeddedContent(f, { unloadIframes: !1 })
        : J.startEmbeddedContent(f),
  ...
  function it(e, t) {
    ...
    if (n) {
      ...
      for (let e = 0; e < n; e++) {
        ...
        n.classList.remove('past'),
          ...
          s
            ...
            : e < t
            ? (n.classList.add(o ? 'future' : 'past'),
              w.fragments &&
                a(n, '.fragment').forEach((e) => {
                  e.classList.add('visible'), e.classList.remove('current-fragment')
                }))
            : e > t &&
              (n.classList.add(o ? 'past' : 'future'),
              w.fragments &&
                a(n, '.fragment.visible').forEach((e) => {
                  e.classList.remove('visible', 'current-fragment')
                }))
      }
      let e = i[t],
      ...
      e.classList.add('present'),
        ...
        o || Ce({ target: e, type: 'visible', bubbles: !1 })
  ...
  function at() {
    ...
    if (n && void 0 !== g) {
      ...
      p && (s = te.isActive() ? 6 : w.mobileViewDistance),
        le.isPrintingPDF() && (s = Number.MAX_VALUE)
      for (let o = 0; o < n; o++) {
        let r = i[o],
          l = a(r, 'section'),
          d = l.length
        if (
          ((e = Math.abs((g || 0) - o) || 0),
          w.loop && (e = Math.abs(((g || 0) - o) % (n - s)) || 0),
          e < s ? J.load(r) : J.unload(r),
          d)
        ) {
          let i = Ue(r)
          for (let a = 0; a < d; a++) {
            let n = l[a]
            ;(t = o === (g || 0) ? Math.abs((v || 0) - a) : Math.abs(a - i)),
              e + t < s ? J.load(n) : J.unload(n)
          }
        }
      }
      gt()
  ...
  function nt({ includeFragments: e = !1 } = {}) {
    let t = $.wrapper.querySelectorAll('.slides>section'),
      ...
      a = { left: g > 0, right: g < t.length - 1, up: v > 0, down: v < i.length - 1 }
    if (
      (w.loop &&
  ...
  function rt(e) {
    ...
    if (e) {
      let t = Oe(e),
        s = t ? e.parentNode : e,
        o = dt()
      ;(i = Math.max(o.indexOf(s), 0)),
        (n = void 0),
        t && (n = Math.max(a(e.parentNode, 'section').indexOf(e), 0))
    }
    if (!e && f) {
  ...
  function yt(e) {
    if ('object' == typeof e) {
      ...
      let t = s(e.paused),
        i = s(e.overview)
      'boolean' == typeof t && t !== Ye() && Xe(t),
        'boolean' == typeof i && i !== te.isActive() && te.toggle(i)
    }
  }
  function wt() {
    if ((Rt(), f && !1 !== w.autoSlide)) {
      ...
      t
        ...
        !j ||
          ...
          Ye() ||
          te.isActive() ||
          ($e() && !ee.availableRoutes().next && !0 !== w.loop) ||
          ((X = setTimeout(() => {
  ...
  function At() {
    j && !_ && ((_ = !0), Ce({ type: 'autoslidepaused' }), clearTimeout(X), y && y.setPlaying(!1))
  }
  function St() {
    j && _ && ((_ = !1), Ce({ type: 'autoslideresumed' }), wt())
  }
  function Et() {
    ;(E.hasNavigatedHorizontally = !0),
      w.rtl
        ? (te.isActive() || !1 === ee.next()) &&
          nt().left &&
          Qe(g + 1, 'grid' === w.navigationMode ? v : void 0)
        : (te.isActive() || !1 === ee.prev()) &&
          nt().left &&
          Qe(g - 1, 'grid' === w.navigationMode ? v : void 0)
  }
  function kt() {
  ...
  function xt() {
    ;(E.hasNavigatedVertically = !0),
      (te.isActive() || !1 === ee.next()) && nt().down && Qe(g, v + 1)
  }
  function Ct() {
    if (!1 === ee.prev())
      if (nt().up) Lt()
        ...
        if (
          ((e = w.rtl
            ? a($.wrapper, '.slides>section.future').pop()
            : a($.wrapper, '.slides>section.past').pop()),
          e)
        ) {
  ...
  function Mt(e) {
    'running' === K &&
      ...
      Ce({
        ...
        data: { indexh: g, indexv: v, previousSlide: m, currentSlide: f },
      }))
  }
  function Dt(e) {
    He()
...
let $ = V,
  K = []
;($.initialize = (e) => (
  Object.assign($, new V(document.querySelector('.reveal'), e)), K.map((e) => e($)), $.initialize()
)),
