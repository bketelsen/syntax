...
;(se.exports = function (e, t, n, r) {
  ...
  'function' == typeof n &&
    ...
    e !== Ye
      ? (i ? !a && e[t] && (o = !0) : delete e[t], o ? (e[t] = n) : Ke(e, t, n))
      : o
      ? (e[t] = n)
      : We(t, n)
  ...
  return [
    ...
    function (e, r) {
      ...
      for (var g, d = '', v = 0, A = 0; A < h.length; A++) {
        D = h[A]
        for (
          var y = String(D[0]), E = Er(mr(gr(D.index), s.length), 0), m = [], k = 1;
          k < D.length;
          k++
        )
  ...
  au(
    ...
    function () {
      ...
      return (
        ...
        t +
        '/' +
        String(void 0 === n && e instanceof RegExp && !('flags' in fu) ? cu.call(e) : n)
      )
    },
    { unsafe: !0 }
  )
      ...
      [
        ...
        function (e, u) {
          ...
          for (var h = 0, D = 0, g = []; D < a.length; ) {
            ...
            if (null === v || (d = Yu(qu(f.lastIndex + (Hu ? D : 0)), a.length)) === h)
              D = Uu(a, D, s)
            else {
...
var ca,
  ...
  ll = Ua(Va, function () {
    ...
    return (
      ((t.constructor = {})[Ha] = n),
      !(al = t.then(function () {}) instanceof n) || (!e && qa && !ol)
    )
  }),
  sl =
    ll ||
  ...
  pl = function (e, t, n) {
    ...
    il
      ...
      !ol && (u = Ea['on' + e])
        ? u(r)
        : 'unhandledrejection' === e && Pa('Unhandled promise rejection', n)
  },
  hl = function (e) {
    Ia.call(Ea, function () {
      var t,
  ...
  { target: 'Array', proto: !0, forced: !Il },
  {
    slice: function (e, t) {
      ...
      if (
        ...
        return $l.call(i, a, l)
      for (r = new (void 0 === n ? Array : n)(Pl(l - a, 0)), u = 0; a < l; a++, u++)
        a in i && Rl(r, u, i[a])
      return (r.length = u), r
    },
  }
...
var rs =
    ...
    function (e, t) {
      ...
      return (
        null !== e
          ? ((es.prototype = Vl(e)), (n = new es()), (es.prototype = null), (n[Ql] = e))
          : (n = ns()),
        void 0 === t ? n : Yl(n, t)
      )
    },
...
var ls,
  ...
  bs = !1
;[].keys &&
  ('next' in (cs = [].keys()) ? (ss = Es(Es(cs))) !== Object.prototype && (ls = ss) : (bs = !0)),
  (null == ls ||
    ys(function () {
      var e = {}
  ...
  Zs = function (e, t, n, r, u, i, o) {
    ...
    if (
      (d &&
        ...
        Ms !== Object.prototype &&
          a.next &&
          (js(a) !== Ms && (Is ? Is(a, Ms) : 'function' != typeof a[Us] && $s(a, Us, qs)),
          zs(a, f, !0))),
      'values' == u &&
        D &&
        'values' !== D.name &&
...
tc(
  ...
  function () {
    ...
    return r >= n.length
      ? { value: void 0, done: !0 }
      : ((e = Qs(n, r)), (t.index += e.length), { value: e, done: !1 })
  }
)
var uc = p,
  ic = ui,
    ...
    concat: function (e) {
      ...
      for (t = -1, r = arguments.length; t < r; t++)
        if (Sc((i = -1 === t ? o : arguments[t]))) {
          if (l + (u = mc(i.length)) > 9007199254740991)
            ...
            if (t) {
              ...
              if (n.header.length === n.align.length) {
                ...
                for (u = n.cells.length, r = 0; r < u; r++)
                  n.cells[r] = Of(n.cells[r], n.header.length)
                return n
              }
            }
          },
          ...
          value: function (e, t) {
            ...
            if (u)
              return (
                (r =
                  '@' === u[2]
                    ? 'mailto:' + (n = Rf(this.options.mangle ? t(u[1]) : u[1]))
                    : (n = Rf(u[1]))),
                {
                  type: 'link',
                  raw: u[0],
...
;(Nf.punctuation = Pf(Nf.punctuation)
  ...
  (Nf.emStrong.rDelimAst = Pf(Nf.emStrong.rDelimAst, 'g')
    .replace(/punct/g, Nf._punctuation)
    .getRegex()),
  (Nf.emStrong.rDelimUnd = Pf(Nf.emStrong.rDelimUnd, 'g')
    .replace(/punct/g, Nf._punctuation)
    .getRegex()),
  (Nf._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
  (Nf._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/),
  (Nf._email = /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/),
...
var Xf = (function () {
    function e(n) {
      ...
      this.options.pedantic
        ...
        : this.options.gfm &&
          ((r.block = Gf.gfm), this.options.breaks ? (r.inline = Hf.breaks) : (r.inline = Hf.gfm)),
              ...
              for (; e; )
                if ((u || (i = ''), (u = !1), (t = this.tokenizer.escape(e))))
                  ...
                  (e = e.substring(t.raw.length)),
                    (t.tokens = this.inlineTokens(t.text, [], a, l)),
                    o.push(t)
                else if ((t = this.tokenizer.autolink(e, Kf)))
                  (e = e.substring(t.raw.length)), o.push(t)
...
function Ep(e, t, n) {
  ...
  if (
    ('function' == typeof t && ((n = t), (t = null)), (t = Dp({}, Ep.defaults, t || {})), gp(t), n)
  ) {
    var r,
      u = t.highlight
    try {
