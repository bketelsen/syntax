...
var Jt = n,
  ...
  ce = function (t) {
    return function (e, n, r) {
      ...
      } else for (; a > o; o++) if ((t || o in i) && i[o] === n) return t || o || 0
      return !t && -1
    }
  },
...
var Ve = Je,
  ...
  nn = (function () {
    var t = /a/,
      e = /b*/g
    return Qe.call(t, 'a'), Qe.call(e, 'a'), 0 !== t.lastIndex || 0 !== e.lastIndex
  })(),
...
var fn = ln && +ln,
  ...
  Mn = function (t, e, n, r) {
    ...
    if (!i || !a || ('replace' === t && (!$n || !On || Ln)) || ('split' === t && !jn)) {
      var o = /./[u],
        l = n(
          u,
          ''[t],
          ...
          { REPLACE_KEEPS_$0: On, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: Ln }
        ),
        s = l[0],
        c = l[1]
...
function pr(t, e) {
  ...
  if (!n) {
    if (Array.isArray(t) || (n = sr(t)) || (e && t && 'number' == typeof t.length)) {
      n && (t = n)
      var r = 0,
        u = function () {}
      return {
  ...
  return [
    ...
    function (t, r) {
      ...
      for (var g, D = '', m = 0, v = 0; v < f.length; v++) {
        h = f[v]
        for (
          var y = String(h[0]), k = Or(Pr(Tr(h.index), s.length), 0), A = [], E = 1;
          E < h.length;
          E++
        )
  ...
  Lr(
    ...
    function () {
      ...
      return (
        ...
        e +
        '/' +
        String(void 0 === n && t instanceof RegExp && !('flags' in Ur) ? Nr.call(t) : n)
      )
    },
    { unsafe: !0 }
  )
...
var Xr,
  ...
  eu = i
    ...
    : function (t, e) {
        Qr(t)
        for (var n, r = tu(e), u = r.length, i = 0; u > i; ) Gr.f(t, (n = r[i++]), e[n])
        return t
      },
...
var fu =
    ...
    function (t, e) {
      ...
      return (
        null !== t
          ? ((cu.prototype = ru(t)), (n = new cu()), (cu.prototype = null), (n[su] = t))
          : (n = du()),
        void 0 === e ? n : uu(n, e)
      )
    },
...
Ze(
  ...
  {
    includes: function (t) {
      return !!~String(xu(this)).indexOf(Cu(t), arguments.length > 1 ? arguments[1] : void 0)
    },
  }
)
var wu = d,
...
Pu(
  { target: 'Array', proto: !0, forced: !Ku },
  {
    slice: function (t, e) {
      ...
      if (
        ju(i) &&
        ('function' != typeof (n = i.constructor) || (n !== Array && !ju(n.prototype))
          ? Lu(n) && null === (n = n[Ju]) && (n = void 0)
          : (n = void 0),
        n === Array || void 0 === n)
      )
        return Hu.call(i, o, l)
      for (r = new (void 0 === n ? Array : n)(Wu(l - o, 0)), u = 0; o < l; o++, u++)
        o in i && qu(r, u, i[o])
      return (r.length = u), r
    },
  }
...
var ii = function (t) {
  ...
  ci = function (t, e) {
    ...
    return (
      li(t) &&
        ('function' != typeof (n = t.constructor) || (n !== Array && !li(n.prototype))
      ...
      (r =
        ...
        ''.split(/.?/).length
          ? function (t, n) {
              ...
              return (
                c === r.length ? (!o && p.test('')) || l.push('') : l.push(r.slice(c)),
      ...
      [
        ...
        function (t, u) {
          ...
          for (var f = 0, h = 0, g = []; h < o.length; ) {
            ...
            if (null === m || (D = Ii(Si(p.lastIndex + (Ti ? h : 0)), o.length)) === f)
              h = wi(o, h, s)
            else {
...
var Ri = D,
  ...
  Li = function (t) {
    return function (e) {
      var n = String(Ri(e))
      return 1 & t && (n = n.replace(Oi, '')), 2 & t && (n = n.replace(Pi, '')), n
    }
  },
...
var qi = k,
  Zi = Z,
  Ki = function (t) {
    if (!qi(t) && null !== t) throw TypeError("Can't set " + String(t) + ' as a prototype')
    return t
  },
  Ji =
...
if (
  ...
  ea(
    ...
    !ma ||
      va ||
      sa(function () {
        return (Da[da] = !1), fa(ga) != ga || fa(Da) == Da || '/a/i' != fa(ga, 'i')
      })
  )
) {
  for (
    var ya = function (t, e) {
        ...
        ma ? u && !i && (t = t.source) : t instanceof ya && (i && (e = aa.call(t)), (t = t.source)),
...
ba(
  { target: 'Array', proto: !0, forced: !_a },
  {
    splice: function (t, e) {
      ...
      if (((u.length = r), n < r)) {
        for (i = c; i < s - r; i++) (o = i + n), (a = i + r) in l ? (l[o] = l[a]) : delete l[o]
...
var Ja = {},
  ...
  Ya = /^([^:]+:\/*[^/]*)[\s\S]*$/
function Va(t, e) {
  Ja[' ' + t] || (Ha.test(t) ? (Ja[' ' + t] = t + '/') : (Ja[' ' + t] = Xa(t, '/', !0)))
  ...
  to = function (t, e) {
    ...
    var n = {
      replace: function (e, r) {
        return (r = (r = r.source || r).replace(qa, '$1')), (t = t.replace(e, r)), n
      },
      getRegex: function () {
              ...
              var n = e[0],
                r = (function (t, e) {
                  ...
                  return e
                    ...
                    .map(function (t) {
                      var e = t.match(/^\s+/)
                      return null === e ? t : lr(e, 1)[0].length >= r.length ? t.slice(r.length) : t
                    })
                    .join('\n')
                })(n, e[3] || '')
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (e) {
              ...
              return { type: 'heading', raw: e[0], depth: e[1].length, text: n }
            }
          },
        },
        {
                ...
                if (
                  ...
                  this.options.pedantic ||
                    ((c = n.match(new RegExp('\\n\\s*\\n {0,' + (u[0].length - 1) + '}\\S'))) &&
                      ((a = n.length - c.index + g.slice(v + 1).join('\n').length),
                  ...
                  if (
                    ...
                    g.splice(
                      ...
                      2,
                      g[v] +
                        (!this.options.pedantic && i[1].length < u[0].length && !g[v].match(/\n$/)
                          ? ''
                          : '\n') +
                        g[v + 1]
                    ),
              ...
              if (n.header.length === n.align.length) {
                ...
                for (r = 0; r < u; r++)
                  /^ *-+: *$/.test(n.align[r])
                    ...
                    : (n.align[r] = null)
                for (u = n.cells.length, r = 0; r < u; r++)
                  n.cells[r] = po(n.cells[r].replace(/^ *\| *| *\| *$/g, ''), n.header.length)
                return n
              }
            }
          },
        ...
        },
        {
          ...
          value: function (t, e) {
            ...
            if ((n = this.rules.inline.url.exec(t))) {
              var r, u
              if ('@' === n[2]) u = 'mailto:' + (r = fo(this.options.mangle ? e(n[0]) : n[0]))
              else {
                var i
                do {
...
;(ko.def = vo(ko.def).replace('label', ko._label).replace('title', ko._title).getRegex()),
  (ko.bullet = /(?:[*+-]|\d{1,9}[.)])/),
  (ko.item = /^( *)(bull) ?[^\n]*(?:\n(?! *bull ?)[^\n]*)*/),
  ...
  (ko.paragraph = vo(ko._paragraph)
    ...
    .replace('tag', ko._tag)
    .getRegex()),
  (ko.blockquote = vo(ko.blockquote).replace('paragraph', ko.paragraph).getRegex()),
  (ko.normal = yo({}, ko)),
  (ko.gfm = yo({}, ko.normal, {
    nptable:
...
;(Ao.punctuation = vo(Ao.punctuation)
  ...
  (Ao.emStrong.lDelim = vo(Ao.emStrong.lDelim).replace(/punct/g, Ao._punctuation).getRegex()),
  ...
  (Ao._email = /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/),
  (Ao.autolink = vo(Ao.autolink)
    .replace('scheme', Ao._scheme)
    .replace('email', Ao._email)
    .getRegex()),
  (Ao._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/),
  (Ao.tag = vo(Ao.tag)
  ...
  (Ao.gfm.url = vo(Ao.gfm.url, 'i').replace('email', Ao.gfm._extended_email).getRegex()),
  (Ao.breaks = yo({}, Ao.gfm, {
...
var _o = (function () {
    function t(e) {
      ...
      this.options.pedantic
        ...
        : this.options.gfm &&
          ((n.block = Co.gfm), this.options.breaks ? (n.inline = xo.breaks) : (n.inline = xo.gfm)),
                ...
                if ((e = this.tokenizer.space(t)))
                  ...
                  (t = t.substring(e.raw.length)),
                    (u = i[i.length - 1]) && 'paragraph' === u.type
                      ? ((u.raw += '\n' + e.raw), (u.text += '\n' + e.text))
                      : i.push(e)
                else if ((e = this.tokenizer.fences(t))) (t = t.substring(e.raw.length)), i.push(e)
                else if ((e = this.tokenizer.heading(t))) (t = t.substring(e.raw.length)), i.push(e)
                else if ((e = this.tokenizer.nptable(t))) (t = t.substring(e.raw.length)), i.push(e)
                else if ((e = this.tokenizer.hr(t))) (t = t.substring(e.raw.length)), i.push(e)
                  ...
                  i.push(e)
                } else if ((e = this.tokenizer.html(t))) (t = t.substring(e.raw.length)), i.push(e)
                else if (a && (e = this.tokenizer.def(t)))
                  (t = t.substring(e.raw.length)),
                    this.tokens.links[e.tag] ||
                      (this.tokens.links[e.tag] = { href: e.href, title: e.title })
                else if ((e = this.tokenizer.table(t))) (t = t.substring(e.raw.length)), i.push(e)
            ...
            value: function (t) {
              ...
              for (e = 0; e < o; e++)
                switch ((a = t[e]).type) {
                  ...
                  case 'table':
                    for (
                      a.tokens = { header: [], cells: [] }, u = a.header.length, n = 0;
                      n < u;
                      n++
                    )
            ...
            value: function (t) {
              ...
              for (; t; )
                if ((u || (i = ''), (u = !1), (e = this.tokenizer.escape(t))))
                  ...
                  (t = t.substring(e.raw.length)),
                    'link' === e.type && (e.tokens = this.inlineTokens(e.text, [], !0, l)),
                    a.push(e)
                else if ((e = this.tokenizer.reflink(t, this.tokens.links))) {
                  t = t.substring(e.raw.length)
                  var d = a[a.length - 1]
                  'link' === e.type
                    ? ((e.tokens = this.inlineTokens(e.text, [], !0, l)), a.push(e))
                  ...
                  (t = t.substring(e.raw.length)), a.push(e)
                else if ((e = this.tokenizer.br(t))) (t = t.substring(e.raw.length)), a.push(e)
              ...
              for (e = 0; e < A; e++)
                switch ((c = t[e]).type) {
                  ...
                  case 'table':
                    ...
                    for (
                      l += this.renderer.tablerow(o), s = '', u = c.cells.length, n = 0;
                      n < u;
                      n++
                    ) {
                  ...
                  case 'list':
                    for (
                      p = c.ordered, d = c.start, f = c.loose, u = c.items.length, s = '', n = 0;
                      n < u;
                      n++
                    )
...
function tl(t, e, n) {
  ...
  if (
    ('function' == typeof e && ((n = e), (e = null)), (e = Wo({}, tl.defaults, e || {})), Yo(e), n)
  ) {
    var r,
      u = e.highlight
    try {
  ...
  try {
    ...
    if (((t.message += '\nPlease report this to https://github.com/markedjs/marked.'), e.silent))
      return '<p>An error occurred:</p><pre>' + Vo(t.message + '', !0) + '</pre>'
    throw t
  }
}
;(tl.options = tl.setOptions = function (t) {
  ...
  (tl.parseInline = function (t, e) {
    ...
    try {
      ...
      return e.walkTokens && tl.walkTokens(n, e.walkTokens), qo.parseInline(n, e)
    } catch (t) {
      if (((t.message += '\nPlease report this to https://github.com/markedjs/marked.'), e.silent))
        return '<p>An error occurred:</p><pre>' + Vo(t.message + '', !0) + '</pre>'
      throw t
      ...
      if (
        ...
        o
          ...
          : i.hasAttribute('data-notes') &&
            ((a.notes = i.getAttribute('data-notes')), (a.whitespace = 'pre-wrap'), (u = null))
      }
      u &&
        ((a.notes = u.innerHTML),
