!(function (t, e) {
  ...
  ;(Q.exports = function (t, e, n, r) {
    ...
    'function' == typeof n &&
      ...
      (u = Jt(n)).source || (u.source = Ht.join('string' == typeof e ? e : ''))),
      t !== Mt
        ? (i ? !o && t[e] && (a = !0) : delete t[e], a ? (t[e] = n) : Nt(t, e, n))
        : a
        ? (t[e] = n)
        : qt(e, n)
      ...
      if (!i || !a || ('replace' === t && (!Pn || !Ln || Mn)) || ('split' === t && !Nn)) {
        var o = /./[u],
          l = n(
            ...
            { REPLACE_KEEPS_$0: Ln, REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE: Mn }
          ),
          s = l[0],
          c = l[1]
  ...
  var Xn = ee,
    ...
    tr = { codeAt: Qn(!1), charAt: Qn(!0) }.charAt,
    er = function (t, e, n) {
    ...
    kr = Dr
      ...
      : function (t) {
          ...
          return void 0 === t
            ...
            : yr
            ? mr(e)
            : 'Object' == (r = mr(e)) && 'function' == typeof e.callee
            ? 'Arguments'
            : r
        },
    Ar = gr
    ...
    return [
      ...
      function (t, r) {
        ...
        for (var g, D = '', m = 0, v = 0; v < f.length; v++) {
          h = f[v]
          for (
            var y = String(h[0]), k = Lr(jr(Ir(h.index), s.length), 0), A = [], E = 1;
            E < h.length;
            E++
          )
  ...
  var Mr = Q.exports,
    ...
    Jr = Kr.toString,
    Hr = Ur(function () {
      return '/a/b' != Jr.call({ source: 'a', flags: 'b' })
    }),
    Wr = Jr.name != Zr
  ;(Hr || Wr) &&
    Mr(
      ...
      function () {
        ...
        return (
          ...
          e +
          '/' +
          String(void 0 === n && t instanceof RegExp && !('flags' in Kr) ? qr.call(t) : n)
        )
      },
      { unsafe: !0 }
    )
  ...
  var tu,
    ...
    uu = i
      ...
      : function (t, e) {
          nu(t)
          for (var n, r = ru(e), u = r.length, i = 0; u > i; ) eu.f(t, (n = r[i++]), e[n])
          return t
        },
    ...
    gu = function () {
      ...
      gu = tu
        ...
        : (((e = pu('iframe')).style.display = 'none'),
          ...
          t.close(),
          t.F)
      for (var n = lu.length; n--; ) delete gu.prototype[lu[n]]
      return gu()
    }
  su[du] = !0
  var Du =
      ...
      function (t, e) {
        ...
        return (
          null !== t
            ? ((fu.prototype = au(t)), (n = new fu()), (fu.prototype = null), (n[du] = t))
            : (n = gu()),
          void 0 === e ? n : ou(n, e)
        )
      },
    ...
    vu = Bn('unscopables'),
    yu = Array.prototype
  null == yu[vu] && mu.f(yu, vu, { configurable: !0, value: Du(null) })
  var ku = fe.includes,
    Au = function (t) {
      yu[vu][t] = !0
    }
  ...
  Mu(
    { target: 'Array', proto: !0, forced: !Wu },
    {
      slice: function (t, e) {
        ...
        if (
          Uu(i) &&
          ('function' != typeof (n = i.constructor) || (n !== Array && !Uu(n.prototype))
            ? Nu(n) && null === (n = n[Yu]) && (n = void 0)
            : (n = void 0),
          n === Array || void 0 === n)
        )
  ...
  var li = function (t) {
    ...
    di = Bn('species'),
      ...
      return (
        pi(t) &&
          ('function' != typeof (n = t.constructor) || (n !== Array && !pi(n.prototype))
            ? ci(n) && null === (n = n[di]) && (n = void 0)
            : (n = void 0)),
            ...
            ? function (t, n) {
                ...
                for (
                  ...
                  !(
                    ...
                    i.length > 1 && i.index < r.length && $i.apply(l, i.slice(1)),
                    (o = i[0].length),
                    (c = a),
                    l.length >= u)
                  );
        ...
        [
          ...
          function (t, u) {
            ...
            for (var f = 0, h = 0, g = []; h < o.length; ) {
              ...
              if (null === m || (D = Oi(_i(p.lastIndex + (Ri ? h : 0)), o.length)) === f)
                h = Ti(o, h, s)
              else {
    ...
    { target: 'Array', proto: !0, forced: !$a },
    {
      splice: function (t, e) {
        ...
        if (
          ...
          throw TypeError(ja)
        for (u = Ia(l, r), i = 0; i < r; i++) (a = c + i) in l && Ra(u, i, l[a])
        if (((u.length = r), n < r)) {
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if ((n = this.rules.inline.url.exec(t))) {
                var r, u
                if ('@' === n[2]) u = 'mailto:' + (r = ko(this.options.mangle ? e(n[0]) : n[0]))
                else {
                  var i
                  do {
  ...
  ;(wo.def = Co(wo.def).replace('label', wo._label).replace('title', wo._title).getRegex()),
    (wo.bullet = /(?:[*+-]|\d{1,9}[.)])/),
    (wo.item = /^( *)(bull) ?[^\n]*(?:\n(?! *bull ?)[^\n]*)*/),
    ...
    (wo.paragraph = Co(wo._paragraph)
      ...
      .replace('tag', wo._tag)
      .getRegex()),
    (wo.blockquote = Co(wo.blockquote).replace('paragraph', wo.paragraph).getRegex()),
    (wo.normal = xo({}, wo)),
    (wo.gfm = xo({}, wo.normal, {
      nptable:
  ...
  ;(So.punctuation = Co(So.punctuation)
    ...
    (So.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g),
    (So.escapedEmSt = /\\\*|\\_/g),
    (So._comment = Co(wo._comment).replace('(?:--\x3e|$)', '--\x3e').getRegex()),
    (So.emStrong.lDelim = Co(So.emStrong.lDelim).replace(/punct/g, So._punctuation).getRegex()),
    ...
    (So._email = /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/),
    (So.autolink = Co(So.autolink)
      .replace('scheme', So._scheme)
      .replace('email', So._email)
      .getRegex()),
    (So._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/),
    (So.tag = Co(So.tag)
    ...
    (So.gfm.url = Co(So.gfm.url, 'i').replace('email', So.gfm._extended_email).getRegex()),
    (So.breaks = xo({}, So.gfm, {
  ...
  var Po = (function () {
      function t(e) {
        ...
        var n = { block: zo.normal, inline: Io.normal }
        this.options.pedantic
