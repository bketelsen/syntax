...
images: ['/fixed/images/canada/mountains.jpg', '/fixed/images/canada/toronto.jpg']
---

![tailwind-nextjs-banner](/fixed/images/twitter-card.png)
...
`public/fixed` - store assets such as images and favicons.
