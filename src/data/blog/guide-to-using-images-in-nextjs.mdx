...
```js
<Image alt="ocean" src="/fixed/images/ocean.jpg" width={256} height={128} />
```

_Note_: If you try to save the image, it is in webp format, if your browser supports it!

![ocean](/fixed/images/ocean.jpeg "My Caption")
...
- All images have to be stored in the `public` folder e.g `/fixed/images/ocean.jpeg`
