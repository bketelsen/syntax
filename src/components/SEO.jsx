...
export const PageSEO = ({ title, description, slug }) => {
  ...
  if (slug) {
     ogImageUrl = `${siteMetadata.siteUrl}/fixed/images/og/pages/${slug}.png`
     twImageUrl = `${siteMetadata.siteUrl}/fixed/images/og/pages/${slug}.png`
  }
...
export const BlogSEO = ({
  ...
  const twImageUrl = `${siteMetadata.siteUrl}/fixed/images/og/blog/${slug}.png`
...
export const ElsewhereSEO = ({
  ...
  const twImageUrl = `${siteMetadata.siteUrl}/fixed/images/og/elsewhere/${slug}.png`
