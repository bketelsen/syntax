export function Bookmark({  href, title, description, image }) {
  return (
    <a href={href} class="not-prose flex flex-col items-center bg-white cursor-pointer rounded-lg border shadow-2xl md:flex-row  hover:bg-slate-100 dark:border-slate-700 dark:bg-slate-800 dark:hover:bg-slate-700">
